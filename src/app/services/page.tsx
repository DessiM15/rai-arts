        ...
        <div className="grid gap-5 lg:grid-cols-2">
          {DOORS.map((d, i) => (
            <Rise key={d.href} delay={i * 0.08}>
              <Link
                href={d.href}
                className="group grain relative isolate flex h-full flex-col justify-between gap-12 overflow-hidden rounded-sm border border-forest/15 bg-white/60 p-8 transition-colors duration-500 hover:bg-white sm:p-10"
              >
                <div className="relative z-[2]">
                  <span className="font-mono text-[0.62rem] tracking-[0.18em] text-gold-deep uppercase">
                    {d.status}
                  </span>
                ...
                <span className="relative z-[2] inline-flex items-center gap-2 font-mono text-[0.66rem] tracking-[0.16em] text-gold-deep uppercase">
                  {d.cta}
                  <span
                    aria-hidden="true"
